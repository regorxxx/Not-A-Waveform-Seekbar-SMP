...
### Integrated in
 ...
 2. [Poobar](https://github.com/Choya5011/Poobar): a responsive and modular 64-bit CUI foobar2000 theme.
...
## Requirements (only one host component required)
 ...
 3. [Optional binaries](https://github.com/regorxxx/foobar2000-assets/tree/main/binaries): ffprobe.
...
## Nightly releases
Automatic package [built from GitHub](https://nightly.link/regorxxx/Not-A-Waveform-Seekbar-SMP/workflows/build/main/file.zip) (using the latest commit). Unzip 'file.zip' downloaded and load the '\*-SMP-\*-\*-\*-package.zip' inside as package within your JS host component.
